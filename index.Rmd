...
```{r}
ggplot(centro_america, aes(x=reorder (name_long, -lifeExp), y=lifeExp)) + ggtitle("Esperanza de vida paises centroamericanos") + xlab("Paises") + ylab("Esperanza de vida") + geom_col() + geom_text(aes(label=lifeExp), vjust=-0.5, size=4)
```
